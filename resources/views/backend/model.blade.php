<div class="d-flex justify-content-between">
    <div>
        <button type="button" class="btn btn-primary " id="#fileModalEdit_" data-bs-toggle="modal" data-bs-target="#fileModalEdit_">
            <i class="fa-solid fa-image pe-1"></i> upload
        </button>
    </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"
                    onclick="closeInnerModal()"></button>
            </div>
            <div class="modal-body">

                <div class="d-flex flex-wrap">
                    @foreach ($all_images as $image)
                        <img src="{{ asset('../uploads/' . $image->name) }}" class="img-fluid m-2 clickable-image"
                            alt="" style="width: 200px; height: 200px;" data-image-id="{{ $image->id }}">
                    @endforeach
                </div>
